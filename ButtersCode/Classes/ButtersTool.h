...
#define kLabelWidth(tLabel) (tLabel.frame.size.width)
//#define kLabelFontWidth(tLabel) ([tLabel.text boundingRectWithSize:CGSizeMake(kLabelWidth(tLabel), MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingTruncatesLastVisibleLine |NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName : tLabel.font} context:nil].size.width)
